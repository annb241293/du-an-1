...
$cateId = isset($_GET['id']) ?  $_GET['id'] : '';
$category = "SELECT ten_loai FROM loai WHERE id_loai = $cateId";
$category = executeQuery($category);
$products = "SELECT * FROM gao WHERE id_loai= $cateId";
$products = executeQuery($products,true);
?>
                                                ...
                                                <div class="single-product-wrap">
                                                    <div class="product-image">
                                                        <a href="single-product.html">
                                                            <img src="images/<?=$p['anh']?>" alt="Li's Product Image">
                                                        </a>
